...
import 'piccolore';
import { j as createRenderInstruction, g as addAttribute, r as renderTemplate, m as maybeRenderHead, i as renderComponent, k as renderHead, l as renderSlot } from './server_CaBh-Yw7.mjs';
import 'clsx';
import { s as siteConfig, n as navItems, c as contactChannels, i as isExternalHref, k as getCanonicalUrl } from './site_CA3Q-_Nt.mjs';
...
const $$ClientRouter = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<meta name="astro-view-transitions-enabled" content="true"><meta name="astro-view-transitions-fallback"${addAttribute(fallback, "content")}>${renderScript($$result, "D:/1_DEV/1_APORTFOLIO/portfolio v3/node_modules/astro/components/ClientRouter.astro?astro&type=script&index=0&lang.ts")}`;
}, "D:/1_DEV/1_APORTFOLIO/portfolio v3/node_modules/astro/components/ClientRouter.astro", void 0);
...
const $$BaseLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>${pageTitle}</title><meta name="description"${addAttribute(description, "content")}><meta name="generator"${addAttribute(Astro2.generator, "content")}><meta name="theme-color" content="#0b0a0f"><meta property="og:type" content="website"><meta property="og:locale"${addAttribute(siteConfig.locale, "content")}><meta property="og:site_name"${addAttribute(siteConfig.shortName, "content")}><meta property="og:title"${addAttribute(pageTitle, "content")}><meta property="og:description"${addAttribute(description, "content")}><meta property="og:url"${addAttribute(canonical, "content")}><meta property="og:image"${addAttribute(getCanonicalUrl(siteConfig.ogImage), "content")}><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title"${addAttribute(pageTitle, "content")}><meta name="twitter:description"${addAttribute(description, "content")}><meta name="twitter:image"${addAttribute(getCanonicalUrl(siteConfig.ogImage), "content")}>${robots ? renderTemplate`<meta name="robots"${addAttribute(robots, "content")}>` : null}<link rel="canonical"${addAttribute(canonical, "href")}><link rel="icon" href="/opengraph-image.png"><link rel="manifest" href="/manifest.webmanifest"><link rel="sitemap"${addAttribute(getCanonicalUrl("/sitemap.xml"), "href")}><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@400;500;600;700&family=DM+Sans:wght@400;500;700&family=Space+Mono:wght@400;700&display=swap" rel="stylesheet">${renderComponent($$result, "ClientRouter", $$ClientRouter, {})}${maybeRenderHead()}<noscript><style>
        [data-simplebar] {
          overflow: auto;
        }
