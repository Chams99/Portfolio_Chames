...
const siteConfig = {
  ...
  description: "Portfolio of Dhibi Chames Eddine, a full-stack web and mobile developer from Tunisia building products with Next.js, Flutter, Node.js, and AI.",
...
function buildProject(input) {
  return {
    ...
    intro: input.intro ?? `${input.title} needed a clearer, stronger digital presence.`,
    problem: input.problem ?? "The core challenge was making the product easier to understand and trust quickly.",
    creativeApproach: input.creativeApproach ?? "I focused on hierarchy, pacing, and a cleaner interface direction.",
    outcome: input.outcome ?? "The result feels clearer, stronger, and more aligned with the product behind it."
  };
}
const projects = [
  buildProject({
    ...
    summary: "A cybersecurity website shaped to feel sharper, more direct, and more trusted.",
    ...
    intro: "Lumina needed a digital presence that felt as credible as the service behind it.",
    problem: "The brand looked too generic for a cybersecurity company that needed instant trust.",
    creativeApproach: "I pushed the interface toward a colder, sharper system with stronger contrast and more command.",
    outcome: "The result feels more technical, more deliberate, and more believable.",
    metrics: [
  ...
  buildProject({
    ...
    year: "2024",
    category: "AI Product",
    summary: "An AI storytelling product framed to feel visual, simple, and cinematic.",
    ...
    intro: "The idea was strong. The product needed to feel exciting before the workflow appeared.",
    problem: "The experience had to feel creative first, not technical first.",
    creativeApproach: "I framed it like a story-led product, with clearer hierarchy and more visual momentum.",
    outcome: "The concept became easier to understand, trust, and want.",
    metrics: [
  ...
  buildProject({
    ...
    year: "2025",
    category: "Web Tool",
    summary: "A website audit tool designed to make performance and SEO checks clearer.",
    ...
    intro: "WebGrade was built to make audits feel fast, clear, and usable.",
    problem: "Most audit tools overwhelm people before they help them.",
    creativeApproach: "I stripped the interface back and organized the results around what matters first.",
    outcome: "The tool feels calmer, clearer, and more actionable.",
    metrics: [
  ...
  buildProject({
    ...
    summary: "A premium real estate platform with a darker, investor-led digital presence.",
  ...
  buildProject({
    ...
    summary: "A cleaner agency platform built for credibility, clarity, and future automation.",
    ...
    intro: "CleanFile needed to feel credible before the deeper system arrived.",
    problem: "The platform had to look organized, reliable, and ready to grow.",
    creativeApproach: "I focused on restraint, status clarity, and a system that could expand cleanly.",
    outcome: "The result feels more operational, more believable, and easier to scale.",
    metrics: [
  ...
  buildProject({
    ...
    year: "2024",
    category: "E-Commerce",
    summary: "A photo printing flow with better editing control and a smoother path to order.",
    ...
    intro: "The flow had to make detailed print edits feel simple enough for everyday users.",
    problem: "Customization breaks fast when zoom, crop, and placement stop feeling predictable.",
    creativeApproach: "I tightened the editor around control, stability, and a clearer ordering flow.",
    outcome: "The experience became smoother, easier to trust, and easier to finish.",
    metrics: [
  ...
  buildProject({
    ...
    year: "2024",
    category: "Healthcare",
    summary: "A premium dental website designed to feel calm, clear, and trusted.",
  ...
  buildProject({
    ...
    year: "2025",
    category: "E-Commerce",
    summary: "A modern e-commerce build focused on speed, flow, and dependable shopping.",
  ...
  buildProject({
    ...
    summary: "An AI fitness landing page with sharper motion and stronger energy.",
  ...
  buildProject({
    ...
    summary: "A football storefront built for clearer browsing and stronger brand presence.",
  ...
  buildProject({
    ...
    summary: "A restaurant website with elegant pacing and a cleaner booking-led experience.",
  ...
  buildProject({
    ...
    summary: "A gaming-themed chat UI that balances atmosphere with cleaner usability.",
  ...
  buildProject({
    ...
    summary: "A premium investment landing page designed for clearer trust and stronger leads.",
  ...
  buildProject({
    ...
    year: "2025",
    category: "Game",
    summary: "A typing game with live feedback and a cleaner performance-first interface.",
  ...
  buildProject({
    ...
    summary: "An interactive star map designed to feel immersive, curious, and easier to explore.",
  ...
  buildProject({
    ...
    summary: "A real-time unit converter with a simpler, faster utility-first interface.",
  ...
  buildProject({
    ...
    summary: "A playful wallpaper generator built around fast experimentation and visual output.",
  ...
  buildProject({
    ...
    year: "2025",
    category: "Game",
    summary: "A browser game shell rebuilt to feel cleaner, lighter, and more polished.",
...
export { processSteps as a, projectSlugs as b, contactChannels as c, projects as d, experience as e, featuredProjects as f, getProjectBySlug as g, heroStats as h, isExternalHref as i, capabilities as j, getCanonicalUrl as k, navItems as n, principles as p, siteConfig as s, trustSignals as t };
